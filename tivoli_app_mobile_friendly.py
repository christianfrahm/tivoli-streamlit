...
# Tilføj lidt styling for "app-følelse"
st.markdown(
    """
    <style>
        .stRadio > div {
...
if st.session_state.step == 1:
    ...
    if st.button("Næste"):
        st.session_state.step = 3 if st.session_state.koncert == "Nej, det er ikke lige mig" else 21
    ...
    if st.button("Næste"):
        st.session_state.step = 6 if st.session_state.forestillinger == "Nej, det er ikke lige mig" else 51
